...
HF_mean_array = np.array(TrainAgg[TrainAgg.columns[HF_vars]], dtype='f4')
TrainAgg['HF_mean_mean'] = np.mean(HF_mean_array, axis=1)
TrainAgg['HF_mean_std'] = np.std(HF_mean_array, axis=1)
...
TrainAgg['HF_mean_mean'] = np.mean(HF_mean_array, axis=1, dtype='f4')
