...
clf = GradientBoostingClassifier(n_estimators=500, learn_rate=5.0, max_depth=100, random_state=0).fit(TrainAppSub[TrainAppSub.columns[vars_to_include]], TrainAppSub['Predicted'])
clf.score(TestAppSub[TestAppSub.columns[vars_to_include]], TestAppSub['Predicted'])  
